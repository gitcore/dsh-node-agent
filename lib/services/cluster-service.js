...
let ClusterService = (() => {
    ...
    return class ClusterService extends _classSuper {
        static {
            ...
            _connectToHub_decorators = [Remote];
            ...
            __esDecorate(this, null, _connectToHub_decorators, { kind: "method", name: "connectToHub", static: false, private: false, access: { has: obj => "connectToHub" in obj, get: obj => obj.connectToHub }, metadata: _metadata }, null, _instanceExtraInitializers);
