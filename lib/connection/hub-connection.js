...
export class HubConnectionManager {
    ...
    requestConnect() {
        if (this.stopped || this.isConnected || this.starting)
            return this._state;
    ...
    async runStart() {
        ...
        connection.on("payloadDispatched", (payload) => this.safe("onPayloadDispatched", () => this.callbacks.onPayloadDispatched(payload)));
