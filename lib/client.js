      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: 12, display: "flex", flexDirection: "column", gap: 10, overflowY: "auto", flex: 1 }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { background: C.bg, borderRadius: 8, padding: 10, border: `1px solid ${C.border}` }, children: [
            ...
            recent.slice(0, 10).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", gap: 8, padding: "4px 0", borderBottom: `1px solid ${C.border}` }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flex: 1 }, title: t.taskId, children: t.taskId }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: t.finishReason === "completed" ? C.ok : C.err, flexShrink: 0 }, children: t.finishReason }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: C.dim, flexShrink: 0 }, children: fmtElapsed(t.durationMs) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: C.dim, flexShrink: 0 }, children: fmtClock(t.finishedAt) })
            ] }, t.taskId))
          ] }),
