...
function ClusterPanel({ wide, getStatus, getActiveTasks, getRecentTasks, getLogs, getMetrics, connectToHub }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ClusterDialog, { getStatus, getActiveTasks, getRecentTasks, getLogs, getMetrics, connectToHub, onClose: () => setOpen(false) })
  ] });
}
...
function ClusterDialog({ getStatus, getActiveTasks, getRecentTasks, getLogs, getMetrics, connectToHub, onClose }) {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: 12, display: "flex", flexDirection: "column", gap: 10, overflowY: "auto", flex: 1 }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { background: C.bg, borderRadius: 8, padding: 10, border: `1px solid ${C.border}` }, children: [
            ...
            status && !status.connected && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                type: "button",
